          ...
          <div className="main">
            ...
            <div id="about">
              <p><span className="dark">My name is Skip, and I'm a front-end developer, currently studying Web Design and Development at Solent University.</span>
                ...
                I hold a <span className="dark">Subsidiary Diploma in Software Development</span> at Distinction*, which I obtained from studying at Sussex Downs College. I also hold A-levels in Computing and Biology, and an AS in Maths. From secondary school education, I gained <span className="dark">6 A grade and 4 B grade GCSEs.</span>
                <br></br>
                <br></br>
