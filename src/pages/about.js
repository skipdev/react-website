          ...
          <div className="main">
            ...
            <div id="about">
              <p><span class="dark">My name is Steph, and I'm a front-end developer, currently working part-time at 3 SIDED CUBE alongside studying Web Design and Development at Solent University.</span>
                ...
                I hold a <span class="dark">Subsidiary Diploma in Software Development</span> at Distinction*, which I obtained from studying at Sussex Downs College. I also hold A-levels in Computing and Biology, and an AS in Maths. From secondary school education, I gained <span class="dark">6 A grade and 4 B grade GCSEs.</span>
                <br></br>
                <br></br>
                ...
                <br></br>
              <p>You can read my blogs <a href='#'>here.</a></p>
            </div>
          </div>
        </div>
      </Layout>
